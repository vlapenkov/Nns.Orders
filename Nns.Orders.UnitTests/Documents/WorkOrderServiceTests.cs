...
public class WorkOrderServiceTests : OrderDbTestBase
{
    ...
    private readonly WorkCycleState _workState;
    ...
    protected override void PrepareData()
    {
        ...
        {
            new WorkCycle
                {Id = 1, StartDate = new DateTime(2020, 1, 1), WorkTypeId = 1, OrderNumber = 1, IsActive = true},
            new WorkCycle
                {Id = 2, StartDate = new DateTime(2020, 1, 1), WorkTypeId = 2, OrderNumber = 2, IsActive = true},
            new WorkCycle
                {Id = 3, StartDate = new DateTime(2020, 1, 1), WorkTypeId = 3, OrderNumber = 3, IsActive = true},

            // �� 02.01 �������� 
            new WorkCycle
                {Id = 4, StartDate = new DateTime(2020, 1, 2), WorkTypeId = 2, OrderNumber = 2, IsActive = false},

            new WorkCycle
                {Id = 5, StartDate = new DateTime(2020, 1, 2), WorkTypeId = 4, OrderNumber = 4, IsActive = false}
        };
    ...
    public async Task AddWorkOrders_ShouldBeCreated()
    {
        ...
        {
            StartDate = new DateTime(2020, 1, 1), ExcavationId = 1, WorkTypeId = 1, EquipmentTypeId = 1,
            OrderNumber = 3, Value = 10
        };
        ...
        model = new WorkOrder
        {
            StartDate = new DateTime(2020, 1, 1), ExcavationId = 1, WorkTypeId = 2, EquipmentTypeId = 2,
            OrderNumber = 7, Value = 10
        };
    ...
    public async Task AddWorkOrder_CantApply_ShouldFail()
    {
        ...
        await funcTask.Should().ThrowAsync<AppException>()
            .WithMessage("Применяемость не активна WorkTypeId=2 EquipmentTypeId=2");
    }
    ...
    public async Task AddWorkOrders_DoenntMeetOrder_ShouldFail()
    {
        ...
        await funcTask.Should().ThrowAsync<AppException>()
            .WithMessage("Порядок видов работ в плане не соответствует порядку в активном производственном цикле");
    }
}